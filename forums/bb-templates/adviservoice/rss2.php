...
<?php foreach ($posts as $bb_post) : ?>
		<item>
			...
			<?php if(get_topic($bb_post->topic_id)->forum_id == 15){ ?>
			...
			<pubDate><?php bb_post_time('D, d M Y H:i:s +'.$bb->gmt_offset.'00', array( 'localize' => false ) ); ?></pubDate>
			<dc:creator>AdviserVoice</dc:creator>
