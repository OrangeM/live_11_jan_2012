...
<?php   }
	...
	if($_REQUEST['type'] == 'cp')
		$wp_error->add('change_profile', __('Please login to change your profile.'), 'message');
...
<?php if (get_option('users_can_register')) : ?>
 | <a href="<?php echo site_url('registration', 'login') ?>"><?php _e('Register') ?></a>
<?php endif; ?>
 | <a href="<?php echo site_url('wp-login.php?type=cp&redirect_to=%2Fwp-admin%2Fprofile.php', '') ?>"><?php _e('Change profile') ?></a>
</p>
...
<form name="registerform" id="registerform" action="<?php echo site_url('registration', 'login_post') ?>" method="post">
	<p>
