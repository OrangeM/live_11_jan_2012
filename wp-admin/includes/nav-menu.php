	...
	function start_el(&$output, $item, $depth, $args) {
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
			...
			<div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
				...
				<p class="field-quiz description description-wide">
					<label for="edit-menu-item-quiz-<?php echo $item_id; ?>">
						<?php _e( 'Show quiz notification' ); ?>
						<input type="checkbox" id="edit-menu-item-quiz-<?php echo $item_id; ?>" class="code edit-menu-item-classes" name="menu-item-quiz[<?php echo $item_id; ?>]" value="" <?php if(esc_attr( get_post_meta($item_id, 'menu-item-quiz', true))  == 1) echo 'checked="checked"'; ?> />
					</label>
				</p>
...
function wp_nav_menu_setup() {
	...
	if( false === get_user_option( 'managenav-menuscolumnshidden' ) ) {
		...
		update_user_option($user->ID, 'managenav-menuscolumnshidden',
			array( 0 => 'link-target', 1 => 'css-classes', 2 => 'xfn', 3 => 'description', 4 => 'quiz' ),
			true);
	}
}
