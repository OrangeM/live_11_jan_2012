                                ...
                                <div class="post-footer">
                                	<div class="post-footer-wrapper">
                                        ...
                                        <div class="post-facebook">
                                        	<iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.adviservoice.com.au&amp;layout=button_count&amp;show_faces=false&amp;width=135&amp;action=recommend&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:135px; height:21px;" allowTransparency="true"></iframe>
                                        </div>    <!--end facebook-->
...
?>
        ...
        <?php
			...
			if ( in_category( 'State of play' ) || post_is_in_descendant_category( 7 ) ) {
			get_sidebar(stateofplay);	}
			
			elseif ( in_category( 'Practice Success' ) || post_is_in_descendant_category( 18 ) ) {
			get_sidebar(practicesuccess);
			}
			
			elseif ( in_category( 'Achieve' ) || post_is_in_descendant_category( 26 ) ) {
			get_sidebar(achieve);
			}
