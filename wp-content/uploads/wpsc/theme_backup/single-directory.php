<?php get_header(); ?>  
    ...
    <h1 class="blue-bg">The Directory</h1>
            ...
            <div class="separator-arrow"> <p><a href="http://www.adviservoice.com.au/the-directory-update">Not listed here, or are your details out of date? Let us know.</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="<?php bloginfo('url')?>/advertise">Want to add the logo to your business profile? Click here</a></p></div>
                                    ...
                                    <div class="business-details">
                                        ...
                                        <div class="detail website-email">
                                            ...
                                            <?php if (get_post_meta($post->ID, 'Website', true)) { ?>
                                                <span class="website"><a href="<?php echo get_post_meta($post->ID, 'Website', true); ?>">Visit Website</a>&nbsp;&nbsp;&nbsp;&nbsp;</span>                                        
                                            <?php } ?> 
