				...
				<tr>
					...
					<td valign="top">
						<select <?php if ( empty($sections) ){ ?> disabled="disabled"<?php }?> name="points">
							<option value="0.25"<?php if ( !isset($edit) && isset($questionValue) && $questionValue == 0.25){?> selected="yes"<?php }?>>0.25</option>
							<option value="0.5" <?php if ( !isset($edit) && isset($questionValue) && $questionValue == 0.5){?> selected="yes"<?php }?>>0.5</option>
							<option value="0.75"<?php if ( !isset($edit) && isset($questionValue) && $questionValue == 0.75){?> selected="yes"<?php }?>>0.75</option>
