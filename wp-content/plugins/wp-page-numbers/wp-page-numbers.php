...
function wp_page_numbers_prevpage($paged, $max_page, $prevpage)
{
	if( $max_page > 1 && $paged > 1 )
		$pagingString = '<li><a class="prev" href="'.get_pagenum_link($paged-1). '"><span class=arrow-txt>'.$prevpage.'</span></a></li>';
	return $pagingString;
}
...
function wp_page_numbers_nextpage($paged, $max_page, $nextpage)
{
	if( $paged != "" && $paged < $max_page)
		$pagingString = '<li><a class="next" href="'.get_pagenum_link($paged+1). '"><span class=arrow-txt>'.$nextpage.'</span></a></li>'."\n";
	return $pagingString;
}
