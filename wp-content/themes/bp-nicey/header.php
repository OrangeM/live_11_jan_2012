		...
		<?php do_action( 'bp_after_header' ) ?>
			...
			<div id="menu-l-corner">
				...
				<ul id="nav">
					...
					<li<?php if ( is_page( BP_HOME_BLOG_SLUG ) ) : ?> class="selected"<?php endif; ?>><a href="<?php echo get_option('home') ?>/<?php echo BP_HOME_BLOG_SLUG ?>" title="<?php _e( 'Blog', 'buddypress' ) ?>"><?php _e( 'Blog', 'buddypress' ) ?></a></li>
